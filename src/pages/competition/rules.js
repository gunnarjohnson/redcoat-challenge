    ...
    <section>
      <div>
        ...
        <p>
          ...
          be judged according to the style they were originally entered in.
      ...
      <div>
        ...
        <p>
          Each entry will consist of three (3) 12-ounce capped bottles that are
          void of all identifying information, including labels and embossing.
          Printed caps are allowed, but discouraged and must be blacked out
          completely. In the case of only 2 bottles are entered, it is at the
          discretion of the Competition Coordinators if the second bottle needs
          to be used during the first round/mini-BOS. If the second bottle is
          used, the entry will not be eligible for the Best of Show round due to
          fact that there is not a bottle available for judging. Bottles must be
          free of labels or other easily identified marks. Re‐used commercial
          bottles with embossed logos are allowed but discouraged. 12oz brown
          glass bottles are preferred; however, green or clear glass and corked
          bottles will be accepted. Swing top bottles will be disqualified and
          not judged. Bottles will not be returned to entrants for any reason.
          Completed bottle labels must be submitted with all entries, and can be
          printed directly from the entry website along with any other required
          paperwork. Bottle labels should be attached to bottles with a rubber
          band only; glue and/or tape are unacceptable. Failure to submit
          entries properly will exclude them from judging.
        </p>
      </div>
    </section>
  </Layout>
